...
@LOSS.register('histogram_loss')
class HistogramLoss(torch.nn.Module):
    def __init__(self, cfg):
        super(HistogramLoss, self).__init__()
        self.step = 2. / (cfg.LOSSES.CLUSTER_LOSS.NUM_STEPS - 1)
        self.eps = 1. / cfg.LOSSES.CLUSTER_LOSS.NUM_STEPS
        self.cuda = cfg.LOSSES.CLUSTER_LOSS.CUDA
