...
@LOSS.register('cluster_loss')
class ClusterLoss(nn.Module):
    def __init__(self, cfg):
        super(ClusterLoss, self).__init__()
        self.use_gpu = cfg.LOSSES.CLUSTER_LOSS.USE_GPU
        self.margin = cfg.LOSSES.CLUSTER_LOSS.MARGIN
        self.ordered = cfg.LOSSES.CLUSTER_LOSS.ORDERED
        self.ids_per_batch = cfg.DATA.TRAIN_BATCHSIZE / cfg.DATA.NUM_INSTANCES
        self.imgs_per_id = cfg.DATA.NUM_INSTANCES
